...
public sealed class CreateDeclarationBeneficiaryRequestValidator : AbstractValidator<CreateDeclarationBeneficiaryRequest>
{
    public CreateDeclarationBeneficiaryRequestValidator()
    {
